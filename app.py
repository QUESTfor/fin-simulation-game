...
MONTHLY_EVENTS = {
    1: {
        "name": "公告：遊戲開始－市場穩定<br>（ประกาศ: เริ่มเกม – ตลาดมีเสถียรภาพ）",
        "description": "歡迎來到金融模擬遊戲！目前市場狀況穩定 （ยินดีต้อนรับสู่เกมจำลองทางการเงิน! สภาวะตลาดขณะนี้มีความมั่นคง）.",
        "alert": {},
        "effects": {}
    },
    2: {
        "name": "公告：生醫新創公司技術突破，股票大漲<br>（ประกาศ: สตาร์ทอัพด้านชีวการแพทย์เกิดความก้าวหน้าทางเทคโนโลยี ราคาหุ้นพุ่งขึ้นอย่างมาก）",
        "description": "*",
        "alert": "🧬 Biomedical stocks soar +30%!",
        "effects": {
            "biomedical_multiplier": 1.30
        }
    },
    3: {
        "name": "公告：市場過熱－利率飆升<br>（ประกาศ: ตลาดร้อนแรงเกินไป – อัตราดอกเบี้ยพุ่งสูงขึ้น）",
        "description": "央行為了降溫經濟，將利率從 1.5% 調升至 3% （ธนาคารกลางปรับขึ้นอัตราดอกเบี้ยจาก 1.5% เป็น 3% เพื่อชะลอเศรษฐกิจ）",
        "alert": "🔥 利率飆升至 3%！幾乎所有股票下跌 7%！ （อัตราดอกเบี้ยพุ่งขึ้นเป็น 3%! หุ้นเกือบทั้งหมดปรับตัวลง 7%!）",
        "effects": {
    ...
    4: {
        "name": "公告：烏克蘭－俄羅斯戰爭升級<br>（ประกาศ: สงครามยูเครน–รัสเซียทวีความรุนแรงขึ้น）",
        "description": "戰爭推動高通膨與高利率，不動產成為避風港 （สงครามทำให้เกิดเงินเฟ้อสูงและอัตราดอกเบี้ยสูง อสังหาริมทรัพย์กลายเป็นสินทรัพย์ปลอดภัย）",
        "alert": "⚔️ 戰爭推升通膨！Pruksa 不動產作為避風港上漲 15%！ （สงครามผลักดันเงินเฟ้อ! พฤกษา เรียลเอสเตทปรับตัวขึ้น 15% ในฐานะสินทรัพย์ปลอดภัย!）",
        "effects": {
    ...
    5: {
        "name": "公告：生醫新創公司數據造假曝光<br>（ประกาศ: เปิดโปงการปลอมแปลงข้อมูลของสตาร์ทอัพด้านชีวการแพทย์）",
        "description": "*",
        "alert": "🚨 生醫詐欺曝光！股價暴跌！ （การฉ้อโกงด้านชีวการแพทย์ถูกเปิดโปง! ราคาหุ้นร่วงลงอย่างหนัก!））",
        "effects": {
            "biomedical_multiplier": 0.10  # -90% crash!
        }
    },
    6: {
        "name": "公告：國會解散－提前選舉；並將於下個月結算，請記得將所有股票與基金賣出<br>（ประกาศ: ยุบสภา – เลือกตั้งก่อนกำหนด และจะมีการชำระบัญชีในเดือนถัดไป โปรดอย่าลืมขายหุ้นและกองทุนทั้งหมด）",
        "description": "總理Anutin Charnvirakul解散國會，為提前選舉鋪路 （นายกรัฐมนตรี อนุทิน ชาญวีรกูล ยุบสภา ปูทางสู่การเลือกตั้งก่อนกำหนด）",
        "alert": "🗳️ 政治不確定性升高！生醫與不動產股下跌 10%！ （ความไม่แน่นอนทางการเมืองเพิ่มขึ้น! หุ้นกลุ่มชีวการแพทย์และอสังหาริมทรัพย์ปรับตัวลง 10%!）",
        "effects": {
    ...
    7: {
        "name": "公告：經濟復甦<br>（ประกาศ: การฟื้นตัวทางเศรษฐกิจ）",
        "description": "*",
        "alert": "📈 Recovery underway!",
        "effects": {
    ...
    8: {
        ...
        "alert": "💻 Tech boom lifts all stocks!",
        "effects": {
    ...
    9: {
        ...
        "alert": "📉 Market correction in progress",
        "effects": {
    ...
    10: {
        ...
        "alert": "🎄 Holiday spending boosts economy!",
        "effects": {
    ...
    12: {
        ...
        "alert": "🏆 Year complete! ETF outperforms!",
        "effects": {
            "etf_bonus": 1.02,
            "mutual_penalty": 0.99,
            "year_end": True
...
def apply_monthly_event(month, game_state, all_players):
    ...
    for group_name, data in all_players.items():
        ...
        if 'biomedical_multiplier' in effects and data.get('biomedical', 0) > 0:
            ...
            player_effects.append(f"生醫新創: \${change:+,}")
        ...
        #這裡好像不是很重要，只要設定etf, mutual price算過就好
...
def home_page():
    st.markdown("<h1 class='center-text' style='font-size: 3.5rem; text-shadow: 3px 3px 6px rgba(0,0,0,0.3);'>一新投資理財遊戲</h1>", unsafe_allow_html=True)
    ...
    with col2:
        ...
        if st.button("🎯 管理員 แอดมิน", use_container_width=True):
        ...
        st.markdown("<div class='emoji-decor'>🎓</div>", unsafe_allow_html=True)
        if st.button("🚀 學生 นักเรียน", use_container_width=True):
...
def admin_login_page():
    ...
    with col2:
        ...
        if st.button("← 返回首頁（กลับสู่หน้าแรก）", use_container_width=True):
            st.session_state.page = 'home'
            st.rerun()
...
def student_login_page():
    st.markdown("<div class='emoji-decor'>🎓👥💼</div>", unsafe_allow_html=True)
    st.markdown("<h1 class='center-text'>歡迎! 精明的投資者們<br>ยินดีต้อนรับนักลงทุนผู้ชาญฉลาดทุกท่าน</h1>", unsafe_allow_html=True)
    st.markdown("<h3 class='center-text' style='color: #667eea;'>選擇隊名(不可包含空白鍵)<br>เลือกชื่อทีม (ห้ามมีช่องว่าง)</h3>", unsafe_allow_html=True)

    col1, col2, col3 = st.columns([1, 1, 1])

    with col2:
        group_name = st.text_input("你的隊名（ชื่อทีมของคุณ）", key="group_name_input", placeholder="e.g., Money Masters")

        if st.button("🚀 開始你的旅程（เริ่มต้นการเดินทางของคุณ）", use_container_width=True):
            if group_name.strip():
                ...
                if not existing_data:
                    ...
                    new_player_data = {
                        ...
                        'savings': 30000,
                        'savings_type': 'simple',
                        'etf': 0,              # ← NEW: Separate ETF
                        'etf_shares': 0,       # ← NEW
                        'mutual': 0,           # ← NEW: Separate Mutual
                        'mutual_shares': 0,    # ← NEW
                        'biomedical': 0,
                        'biomedical_shares': 0,
                        'real_estate': 0,
...
def student_game_page():
    ...
    if player_data.get('is_broke', False):
        st.markdown("<h1 class='center-text' style='color: #e53e3e;'>你破產了! 遊戲結束</h1>", unsafe_allow_html=True)
    ...
    if player_data.get('submitted', False):
        ...
        st.info("✅ 已收到你的提交！正在等待管理員推進到下個月……（ได้รับการส่งข้อมูลของคุณเรียบร้อยแล้ว! กำลังรอผู้ดูแลระบบดำเนินการไปยังเดือนถัดไป…）")
        ...
        st.markdown("### 📊 本月摘要（สรุปผลของเดือนนี้）")

        # Show current month allocation (now with 7 columns for loan and lottery)
        col1, col2, col3, col4, col5, col6, col7 = st.columns(7)

        with col1:
            st.metric("🏦 Savings", f"${player_data.get('savings', 0):,.0f}")

        with col2:
            etf_value = player_data.get('etf', 0)
            etf_shares = player_data.get('etf_shares', 0)
            st.metric("📈 ETF tracks SET Index", f"{etf_shares} shares")
            if etf_shares > 0:
        ...
        with col6:
            ...
            if player_data.get('loan_balance', 0) > 0:
                st.metric("💳 Loan", f"${player_data['loan_balance']:,.0f}")
            else:
                st.metric("💳 Loan", "$0")
        ...
        if this_month_lottery:
            ...
            with col_lot1:
                st.caption(f"🎰 Lottery Stake: ${this_month_lottery['stake']:,.0f}")

            with col_lot2:
                if this_month_lottery['won']:
                    profit = this_month_lottery['prize'] - this_month_lottery['stake']
                    st.success(f"🎉 WON ${this_month_lottery['prize']:,.0f} (Profit: +${profit:,.0f})")
                else:
                    st.error(f"💸 LOST ${this_month_lottery['stake']:,.0f}")

        st.markdown("<br>", unsafe_allow_html=True)

        # ========== THIS MONTH RESULT ==========
        st.markdown("### 💰 本月結果（ผลลัพธ์ของเดือนนี้）")
        ...
        with col_r1:
            st.success(f"💵 Income: +${expected_income:,.2f} (next month)")
            if savings_interest > 0:
                st.success(f"🏦 儲蓄 การออมเงิน: +${savings_interest:,.2f}")
            if bio_return > 0:
                st.success(f"🧬 Bio: +${bio_return:,.2f}")
            if re_return > 0:
                st.success(f"🏠 RE: +${re_return:,.2f}")

        with col_r2:
            st.error(f"🏠 日常開銷（ค่าใช้จ่ายประจำวัน）: -${expected_expenses:,.2f}")
            if etf_fee > 0:
                st.error(f"💳 ETF Fee: -${etf_fee:,.2f}")
            if mutual_fee > 0:
                st.error(f"💳 Mutual Fee: -${mutual_fee:,.2f}")
            if loan_interest > 0:
                st.error(f"💳 貸款（เงินกู้）: -${loan_interest:,.2f}")
        ...
        with col_r4:
            ...
            st.metric("💰 下個月儲蓄（เงินออมของเดือนถัดไป）", f"${next_month_savings:,.0f}")
            st.caption("（可動用現金）（เงินสดที่สามารถใช้จ่ายได้）")
        ...
        if current_month < 12:
            st.markdown("### 📈 下個月股價預覽（ตัวอย่างราคาหุ้นของเดือนถัดไป）")
            ...
            with col_p1:
                ...
                st.markdown("**🧬 生醫新創:**")
                st.write(f"Current: ${bio_current} → Next: ${bio_next}")
                if bio_pct > 0:
            ...
            with col_p2:
                ...
                st.markdown("**🏠 Pruksa Real Estate（พฤกษา เรียลเอสเตท）:**")
                st.write(f"Current: ${re_current} → Next: ${re_next}")
                if re_pct > 0:
        ...
        if fresh_player_data.get('month', 0) < fresh_game_state['current_month']:
            st.success("🎉 Admin has advanced to the next month!")
            st.cache_data.clear()
            time.sleep(1)
            st.rerun()
        # ========== VIEW ACCOUNTING BUTTON (MOVED HERE, ABOVE REFRESH) ==========
        if st.button("📊 查看交易紀錄（ดูประวัติการทำธุรกรรม）", use_container_width=True, key="accounting_waiting"):
            st.session_state.page = 'student_accounting'
            st.rerun()

        # Refresh button for WAITING ROOM
        if st.button("🔄 更新狀態（รีเฟรชสถานะ）", use_container_width=True):
            st.cache_data.clear()
            st.rerun()
    ...
    with col_info:
        st.caption(f"⏰ Last updated: {time_since_refresh}s ago")
    with col_refresh:
    ...
    st.markdown("### 💹 市場狀態 สภาวะตลาด")
    col_rate1, col_rate2, col_rate3, col_rate4 = st.columns(4)
    with col_rate1:
        st.info(f"🏦 儲蓄 การออมเงิน: {game_state['interest_rate']:.1f}% annual")
    with col_rate2:
        st.info(f"💳 貸款（เงินกู้）: {game_state['loan_rate']:.1f}% annual")

    st.markdown("<br>", unsafe_allow_html=True)

    # Expense section
    st.markdown("<h2 style='text-align: center; color: white;'>每月支出（รายจ่ายรายเดือน）</h2>", unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("### 🏠 日常生活（การใช้ชีวิตประจำวัน）")
    ...
    st.markdown(f"<h3 style='text-align: center; color: #1a1a1a;'>1️⃣ 支出後（หลังหักค่าใช้จ่าย）: ${remaining_for_investment:,.0f}</h3>", unsafe_allow_html=True)
    st.markdown("<br>", unsafe_allow_html=True)
    ...
    with col_loan1:
        ...
        if max_loan > 0:
            inv_loan = st.number_input(
                ...
                min_value=0,
                max_value=max_loan,
                value=st.session_state.inv_loan,  # ← Use session state
                step=1000,
                key="loan_input"
            )
    ...
    with col_loan2:
      ...
      st.metric("Monthly Rate", f"{monthly_loan_rate:.1f}%")  # ← Shows 6.0%
      st.caption(f"({annual_loan_rate:.0f}% annual)")
      if total_loan_balance > 0:
          st.caption(f"≈ ${monthly_loan_interest:,.2f}/month")

    with col_loan3:
        if inv_loan > 0:
            monthly_payment = inv_loan * (monthly_loan_rate / 100 / 12)
            st.metric("New Loan Interest", f"${monthly_payment:,.2f}")
            st.warning("⚠️ Must repay!")

    # ADD LOAN TO AVAILABLE MONEY
    remaining_for_investment += inv_loan  # ← FIX: Now loan can be used!

    st.markdown(f"<h3 style='text-align: center; color: white;'>2️⃣ 加入貸款後（หลังเพิ่มเงินกู้）: ${remaining_for_investment:,.0f}</h3>", unsafe_allow_html=True)
    # ========== END LOAN SECTION ==========

    # ========== LOTTERY SECTION ==========
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("### 🎰 **每月彩券（選填）（ลอตเตอรี่รายเดือน (ไม่บังคับ)）**")

    col_lot1, col_lot2 = st.columns([2, 1])

    with col_lot1:
        st.info( "🎲 **機率（ความน่าจะเป็น）：**\n" "- **10% 機率：** 獲得 130%（每投入 $100 可拿回 $130）\n" "- **1% 機率：** 獲得 200%（每投入 $100 可拿回 $200）" )
        ...
        if max_lottery > 0:
            lottery_amount = st.number_input(
                ...
                value=min(st.session_state.lottery_amount, max_lottery),  # ← Use session state
                step=100,
                key="lottery_input"  # ← Keep this one
            )
            st.session_state.lottery_amount = lottery_amount  # ← Save back

            if lottery_amount > 0:
                st.warning(f"⚠️ You're betting \${lottery_amount:,.0f}")
        else:
            st.error("❌ Not enough funds for lottery!")
            lottery_amount = 0
            st.session_state.lottery_amount = 0
    ...
    with col_lot2:
        ...
        if lottery_history:
            st.markdown("#### 📜 彩券交易紀錄（ประวัติการทำรายการลอตเตอรี่）")
            ...
            for i, record in enumerate(reversed(lottery_history[-3:])):
                ...
                if record['won']:
                    st.success(f"{month_name}: +\${record['prize']:,.0f} 🎉")
                else:
                    st.error(f"{month_name}: -\${record['stake']:,.0f} 💸")
            ...
            st.caption("目前尚無彩券紀錄（ยังไม่มีประวัติลอตเตอรี่）")

    #Deduct lottery from available funds
    remaining_for_investment -= lottery_amount

    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown(f"<h2 style='text-align: center; color: white;'>3️⃣ 可投資金額（เงินที่สามารถนำไปลงทุนได้）: ${remaining_for_investment:,.0f}</h2>", unsafe_allow_html=True)

    if remaining_for_investment < 0:
        st.error("⚠️ 你的支出已超過你的總資產！你可能需要貸款，否則將會破產！<br>（ค่าใช้จ่ายของคุณสูงกว่าสินทรัพย์ทั้งหมด! คุณอาจจำเป็นต้องกู้เงิน มิฉะนั้นอาจล้มละลายได้!）!")

    # ========== INVESTMENT SECTION ==========
    st.markdown("<br>", unsafe_allow_html=True)

    # Row 1: Savings (with interest type choice)
    st.markdown("### 🏦 儲蓄（การออมเงิน）")
    ...
    with col_sav1:
        ...
        if remaining_for_investment > 0:
            ...
            # Compound interest calculation: P × ((1 + r)^t - 1)
            compound_monthly_rate = annual_rate / 100 / 12
            compound_interest = remaining_for_investment * compound_monthly_rate

            st.info(f"💡 With ${remaining_for_investment:,.0f} at {annual_rate:.1f}% annual:\n\n"
                   f"**Simple Interest:**\n"
                   f"  公式： 本金 × ({annual_rate:.1f}% ÷ 12)\n"
                   f"  = \${remaining_for_investment:,.0f} × {simple_monthly_rate:.3f}%\n"
                   f"  = \${simple_interest:,.2f}/month\n\n"
                   f"**Compound Interest:**\n"
                   f"  公式： 本金 × [(1 + {annual_rate:.1f}%/12)¹ - 1]\n"
                   f"  = \${remaining_for_investment:,.0f} × {compound_monthly_rate:.4f}\n"
    ...
    with col_sav2:
        ...
        if savings_type == "Simple Interest":
            ...
            st.caption("📊 Simple calculation")
        else:
            monthly_rate = annual_rate / 12
            st.metric("Monthly Rate", f"{monthly_rate:.3f}%")
            st.caption(f"({annual_rate:.1f}% annual)")
            st.caption("📈 Compounds monthly")

    # Row 2: Fund (ETF AND Mutual - can buy both!)
    st.markdown("### 📈 基金（กองทุน）")
    ...
    tab_etf, tab_mutual = st.tabs(["📈 ETF tracks SET Index", "📊 共同基金（กองทุนรวม）"])

    with tab_etf:
      st.markdown("#### 📊 ETF tracks SET Index")
      ...
      with col_etf1:
          st.markdown(f"### 💵 Current Price: ${etf_price}/一股")

          if current_etf_shares > 0:
              st.info(f"📊 Holdings: {current_etf_shares} shares (${current_etf_value:,.0f})")
          else:
              st.info(f"📊 Holdings: 0 shares")
          ...
          if action == "Buy":
              ...
              if shares_to_buy > 0:
                  st.success(f"➕ Buying {shares_to_buy} shares = ${inv_etf:,.0f}")
              ...
              if shares_to_sell > 0:
                  st.warning(f"➖ Selling {shares_to_sell} shares = +${abs(inv_etf):,.0f} cash")

          else:  # Hold
              inv_etf = 0
              etf_share_change = 0
              st.session_state.etf_shares_input = 0
              st.success(f"✓ Holding {current_etf_shares} shares (${current_etf_value:,.0f})")
          ...
          with col_etf2:
              ...
              st.metric("月費（ค่าธรรมเนียมรายเดือน）", f"{monthly_fee_rate:.3f}%")
              st.caption(f"≈ ${monthly_fee_amount:,.2f}/month")  # ← SHOW DOLLAR AMOUNT
              st.caption("✅ Low cost")
    ...
    with col_mut1:
        st.markdown(f"### 💵 Current Price: ${mutual_price}/一股")

        if current_mutual_shares > 0:
            st.info(f"📊 Holdings: {current_mutual_shares} shares (${current_mutual_value:,.0f})")
        else:
            st.info(f"📊 Holdings: 0 shares")
        ...
        action = st.radio(
            ...
            index=["Hold", "Buy", "Sell"].index(st.session_state.mutual_action)  # ← Preserve
        )
        st.session_state.mutual_action = action  # ← Save back
        ...
        if action == "Buy":
            ...
            shares_to_buy = st.number_input(
                ...
                value=min(st.session_state.mutual_shares_input, max_shares),  # ← Preserve (capped)
                step=1,
                key="mutual_buy"
            )
            st.session_state.mutual_shares_input = shares_to_buy  # ← Save back
            inv_mutual = shares_to_buy * mutual_price
            mutual_share_change = shares_to_buy
            if shares_to_buy > 0:
                st.success(f"➕ Buying {shares_to_buy} shares = ${inv_mutual:,.0f}")
        elif action == "Sell":
            shares_to_sell = st.number_input(
                "Shares to Sell",
                min_value=0,
                max_value=current_mutual_shares,
                value=min(st.session_state.mutual_shares_input, current_mutual_shares),  # ← Preserve (capped)
                step=1,
                key="mutual_sell"
            )
            st.session_state.mutual_shares_input = shares_to_sell  # ← Save back
            inv_mutual = -shares_to_sell * mutual_price
            mutual_share_change = -shares_to_sell
            if shares_to_sell > 0:
                st.warning(f"➖ Selling {shares_to_sell} shares = +${abs(inv_mutual):,.0f} cash")
        else:  # Hold
            inv_mutual = 0
            mutual_share_change = 0
            st.session_state.mutual_shares_input = 0  # ← Reset when holding
            st.success(f"✓ Holding {current_mutual_shares} shares (${current_mutual_value:,.0f})")
        ...
        with col_mut2:
            ...
            st.metric("月費（ค่าธรรมเนียมรายเดือน）", f"{monthly_fee_rate:.2f}%")
            st.caption(f"≈ ${monthly_fee_amount:,.2f}/month")  # ← SHOW DOLLAR AMOUNT
            st.caption("⚠️ Higher fee")
    ...
    st.markdown("---")
    st.markdown("#### 📊 基金價格歷史紀錄（ประวัติราคากองทุน）")
    ...
    if current_month >= 1:
            ...
            if etf_current > mutual_current:
                ...
                st.success(f"✅ ETF tracks SET Index is ahead by \${diff:,.0f} ({diff_pct:+.1f}%)")
            elif mutual_current > etf_current:
                diff = mutual_current - etf_current
                diff_pct = ((mutual_current / etf_current - 1) * 100)
                st.info(f"📊 共同基金（กองทุนรวม） is ahead by \${diff:,.0f} ({diff_pct:+.1f}%)")
            else:
                st.info("📊 Both funds are currently tied")
    else:  # ← MOVE THIS UP TO MATCH THE OUTER if current_month >= 1
      st.info("📊基金價格歷史紀錄將自第 2 個月起顯示（ประวัติราคากองทุนจะแสดงตั้งแต่เดือนที่ 2 เป็นต้นไป）")

        # ========== END OF FUND HISTORY ==========


    # Row 4: Stocks with Buy/Sell functionality and Simplified Price History
    st.markdown("### 📊 股市（ตลาดหุ้น）")
    ...
    # NOW create the tabs
    tab1, tab2 = st.tabs(["🧬 生醫新創公司（สตาร์ทอัพด้านชีวการแพทย์）", "🏠 Pruksa Real Estate（พฤกษา เรียลเอสเตท）"])
    ...
    with tab1:
        ...
        if current_month >= 1:
            ...
            st.info("📊 Price history will show from Month 2 onwards")
    ...
    with col_bio1:
        st.markdown(f"### 💵 Current Price: ${biomedical_price}/一股")

        if current_bio_shares > 0:
            current_value = current_bio_shares * biomedical_price
            st.info(f"📊 Holdings: {current_bio_shares} shares (${current_value:,.0f})")
        ...
        action = st.radio(
            ...
            index=["Hold", "Buy", "Sell"].index(st.session_state.bio_action)  # ← Preserve
        )
        st.session_state.bio_action = action  # ← Save back
        ...
        if action == "Buy":
            ...
            shares_to_buy = st.number_input(
                ...
                min_value=0,
                max_value=max_shares,
                value=min(st.session_state.bio_shares_input, max_shares),  # ← Preserve (capped)
                step=1,
                key="bio_buy"
            )
            st.session_state.bio_shares_input = shares_to_buy  # ← Save back
            inv_biomedical = shares_to_buy * biomedical_price
            bio_share_change = shares_to_buy
            if shares_to_buy > 0:
                st.success(f"➕ Buying {shares_to_buy} shares = ${inv_biomedical:,.0f}")
        elif action == "Sell":
            shares_to_sell = st.number_input(
                "Shares to Sell",
                min_value=0,
                max_value=current_bio_shares,
                value=min(st.session_state.bio_shares_input, current_bio_shares),  # ← Preserve (capped)
                step=1,
                key="bio_sell"
            )
            st.session_state.bio_shares_input = shares_to_sell  # ← Save back
            inv_biomedical = -shares_to_sell * biomedical_price
            bio_share_change = -shares_to_sell
            if shares_to_sell > 0:
                st.warning(f"➖ Selling {shares_to_sell} shares = +${abs(inv_biomedical):,.0f} cash")
        else:  # Hold
            inv_biomedical = 0
            bio_share_change = 0
            st.session_state.bio_shares_input = 0  # ← Reset when holding
            st.success(f"✓ Holding {current_bio_shares} shares (${current_bio_shares * biomedical_price:,.0f})")

        with col_bio2:
          monthly_rate = game_state.get('biomedical_return_rate', 180.0) / 12
          st.metric("股利（每月）（เงินปันผลรายเดือน）", f"{monthly_rate:.1f}%")  # Shows 15.0%
        ...
        with col_bio3:
            if current_bio_value > 0:
              ...
              st.metric("預期股利（每月）（เงินปันผลที่คาดว่าจะได้รับรายเดือน）", f"${monthly_return:,.2f}")
    ...
    with tab2:
      ...
      with col_re1:
          st.markdown(f"### 💵 Current Price: ${real_estate_price}/一股")

          if current_re_shares > 0:
              current_value = current_re_shares * real_estate_price
              st.info(f"📊 Holdings: {current_re_shares} shares (${current_value:,.0f})")
          ...
          action = st.radio(
              ...
              horizontal=True,
              key="re_action_radio",
              index=["Hold", "Buy", "Sell"].index(st.session_state.re_action)  # ← Preserve
          )
          st.session_state.re_action = action  # ← Save back
          ...
          if action == "Buy":
              ...
              shares_to_buy = st.number_input(
                  ...
                  min_value=0,
                  max_value=max_shares,
                  value=min(st.session_state.re_shares_input, max_shares),  # ← Preserve (capped)
                  step=1,
                  key="re_buy"
              )
              st.session_state.re_shares_input = shares_to_buy  # ← Save back
              inv_real_estate = shares_to_buy * real_estate_price
              re_share_change = shares_to_buy
              if shares_to_buy > 0:
                  st.success(f"➕ Buying {shares_to_buy} shares = ${inv_real_estate:,.0f}")
          elif action == "Sell":
              shares_to_sell = st.number_input(
                  "Shares to Sell",
                  min_value=0,
                  max_value=current_re_shares,
                  value=min(st.session_state.re_shares_input, current_re_shares),  # ← Preserve (capped)
                  step=1,
                  key="re_sell"
              )
              st.session_state.re_shares_input = shares_to_sell  # ← Save back
              inv_real_estate = -shares_to_sell * real_estate_price
              re_share_change = -shares_to_sell
              if shares_to_sell > 0:
                  st.warning(f"➖ Selling {shares_to_sell} shares = +${abs(inv_real_estate):,.0f} cash")
          else:  # Hold
              inv_real_estate = 0
              re_share_change = 0
              st.session_state.re_shares_input = 0  # ← Reset when holding
              st.success(f"✓ Holding {current_re_shares} shares (${current_re_shares * real_estate_price:,.0f})")
      with col_re2:
          monthly_rate = game_state.get('real_estate_return_rate', 84.0) / 12
          st.metric("股利（每月）（เงินปันผลรายเดือน）", f"{monthly_rate:.1f}%")  # Shows 7.0%
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("### 🥧 目前投資配置（สัดส่วนการลงทุนปัจจุบัน）")
    ...
    # 這裡計算完 savings 了
    st.markdown(f"<h3 style='text-align: center; color: white;'>4️⃣ 剩餘作為儲蓄（เงินที่เหลือเป็นเงินออม）: ${savings:,.0f}</h3>", unsafe_allow_html=True)

    if savings < 0:
        st.error("❌ You've allocated more than available! Reduce your investments.")
        return  # ✅ 這裡的縮排必須跟 st.error 對齊

    # 錢夠用的情況下，繼續往下跑
    if savings < 1 and inv_loan == 0:
        st.warning("⚠️ Warning: Savings below $1 will result in bankruptcy!")
...
# ========== VIEW ACCOUNTING BUTTON (MOVED HERE, ABOVE REFRESH) ==========
    ...
    # Submit button
    if st.button("📤 提交你的投資配置（ส่งการจัดสรรการลงทุนของคุณ）", use_container_width=True, type="primary"):
    ...
    if st.session_state.get('show_confirm', False):
        ...
        with col_yes:
            if st.button("✅ Yes, I'm Sure!", use_container_width=True):
                ...
                if lottery_amount > 0:
                    ...
                    if roll < 0.01:
                        ...
                        save_transaction(group_name, {
                            'type': 'Investment Gain',
                            'amount': prize,
                            'description': f'🎰 Lottery JACKPOT! (200% return)',
                            'month': current_month
                        })
                        ...
                        save_transaction(group_name, {
                            'type': 'Investment Gain',
                            'amount': prize,
                            'description': f'🎰 Lottery WIN! (130% return)',
                            'month': current_month
                        })
                    else:
                ...
                # Update player data
                player_data.update({
                    'total_asset': liquid_cash,  # ← This should be your final savings amount!
                    'savings': liquid_cash,      # ← Same as total_asset
                    'etf': new_etf_value,        # ← Track but NOT in total_asset
                    'etf_shares': new_etf_shares,
                    'mutual': new_mutual_value,  # ← Track but NOT in total_asset
                    'mutual_shares': new_mutual_shares,
                    'biomedical': new_bio_value, # ← Track but NOT in total_asset
                    'biomedical_shares': new_bio_shares,
                    'real_estate': new_re_value, # ← Track but NOT in total_asset
...
def student_accounting_page():
    ...
    st.markdown("<h1 class='center-text' style='color: white;'>📊 Accounting & Transaction History</h1>", unsafe_allow_html=True)
    st.markdown(f"<h2 class='center-text' style='color: white;'>Team: {group_name}</h2>", unsafe_allow_html=True)

    # Back button
    if st.button("← Back to Game", use_container_width=False):
        st.session_state.page = 'student_game'
        st.rerun()
    ...
    if not all_transactions:
        st.info("📝 No transaction history yet. Start playing to see your financial records!")
        return
    ...
    st.markdown(f"### 📋 Transaction Ledger - {display_month}")
    ...
    #with col3:
        #st.metric("📊 Net P&L", f"${net:,.2f}", delta=f"{net:+,.2f}")
    with col4:
    ...
    if filtered_transactions:
        ...
        for t in filtered_transactions:
            transaction_data.append({
                ...
                'Category': '💰 Income' if t['type'] in ['Income', 'Investment Gain', 'Interest Earned', 'Investment Sale', 'Stock Sale'] else '💸 Expense'
            })
...
def admin_dashboard_page():
    ...
    st.markdown("<div class='emoji-decor'>👨‍💼📊💼</div>", unsafe_allow_html=True)
    st.markdown("<h1 class='center-text' style='color: white; text-shadow: 3px 3px 6px rgba(0,0,0,0.5);'>遊戲主持人儀表板</h1>", unsafe_allow_html=True)
    ...
    with col_btn2:
        if st.button("🎲 隨機事件", use_container_width=True):
            st.session_state.page = 'admin_events'
            st.rerun()

    with col_btn3:
      if st.button("➡️ 前往下個月 收入+10K", use_container_width=True):
          with st.spinner("Processing month advancement..."):
              event, event_log = advance_month()
              st.cache_data.clear()

          # Show event results
          st.success(f"✅ Advanced to {MONTHS[(game_state['current_month'])]}")
          st.info(f"📢 Event: {event['name']}")
    ...
    with col_btn5:
        if st.button("🏆 結算遊戲", use_container_width=True):
    ...
    st.markdown(f"<h2 style='font-size: 2.1rem; color: #1a1a1a;'>📅 {event['name']}</h2>", unsafe_allow_html=True)
    ...
    if players_with_loans:
        st.info(f"📊 {len(players_with_loans)} players currently have outstanding loans")

        if st.button("💰 Force All Players to Repay Loans", use_container_width=True, type="primary"):
            st.session_state.show_loan_repay_confirm = True

        if st.session_state.get('show_loan_repay_confirm', False):
            st.warning("⚠️ This will IMMEDIATELY deduct loan principals from all players' assets!")

            col_yes, col_no = st.columns(2)

            with col_yes:
                if st.button("✅ Yes, Force Repayment", use_container_width=True):
                    repayment_log = []
                    ...
                    st.success(f"✅ Loan repayment completed for {len(repayment_log)} players!")

                    with st.expander("📋 Repayment Details"):
        ...
        st.success("✅ No players currently have outstanding loans")
    ...
    _ ="""
    #st.markdown("### ⚡ Force Update Game Rates")
    #st.info("Use this to update Firebase with corrected fee and return rates")

    if st.button("⚡ FORCE UPDATE All Game Rates", use_container_width=True, type="primary"):
        update_game_state({
        ...
        st.success("✅ All rates updated successfully!")
        st.balloons()
        st.cache_data.clear()
        time.sleep(1)
        st.rerun()
    ...
    if st.button("🔄 Reset Game to January", use_container_width=True, type="primary"):
        st.session_state.show_reset_confirm = True

    if st.session_state.get('show_reset_confirm', False):
        st.warning("⚠️ WARNING: This will DELETE ALL PLAYERS and reset to Month 1!")
        ...
        with col_confirm:
            if st.button("✅ Yes, Reset Everything", use_container_width=True):
                ...
                st.success("✅ Game reset to January! All players deleted.")
                st.cache_data.clear()
                time.sleep(1)
                st.rerun()
        with col_cancel:
    ...
    if next_month <= 12:
        ...
        with st.expander(f"👀 Preview: Next Month's Event"):
    ...
    if not all_players:
        st.info("📢 目前尚無玩家加入，請將遊戲連結分享給學生！ （ยังไม่มีผู้เล่นเข้าร่วม โปรดแชร์ลิงก์เกมให้กับนักเรียน!）")
        return
...
def display_player_card(group_name, data):
    ...
    # ← ADD BROKE EMOJI HERE
    broke_emoji = " 💀" if data.get('is_broke', False) else ""
    st.markdown(f"### 👤 {group_name}{broke_emoji}")

    st.markdown(f"**{status}**")
    st.markdown(f"<h4 style='color: #48bb78;'>💰 Savings: ${data['total_asset']:,.0f}</h4>", unsafe_allow_html=True)

    if data.get('loan_balance', 0) > 0:
        st.warning(f"💳 貸款（เงินกู้）: ${data['loan_balance']:,.0f}")
    ...
    with st.expander("📊 View Details"):
        ...
        st.write(f"**ETF:** ${data.get('etf', 0):,} ({data.get('etf_shares', 0)} shares)")  # ← ADDED
        st.write(f"**共同基金:** ${data.get('mutual', 0):,} ({data.get('mutual_shares', 0)} shares)")  # ← ADDED
        st.write(f"**生醫新創:** ${data.get('biomedical', 0):,} ({data.get('biomedical_shares', 0)} shares)")
        ...
        st.write(f"**破產:** {'💀 Yes' if data.get('is_broke', False) else '✅ No'}")
...
def admin_events_page():
    ...
    if event_choice == "Card I: Trade War":
        ...
        with col1:
            if st.button("🎲 揭示結果（เปิดเผยผลลัพธ์）", key="reveal_tariff", use_container_width=True):
                st.session_state.tariff_revealed = True
                st.rerun()

        if st.session_state.get('tariff_revealed', False):
            st.markdown("<div style='background: #fffaf0; color: #744210; padding: 1rem; border-radius: 8px; border-left: 4px solid #dd6b20; font-size: 2.5rem; font-weight: 600;'>⚠️ 結果： 飲食成本增加 10% （ผลลัพธ์: ค่าอาหารเพิ่มขึ้น 10%）</div>", unsafe_allow_html=True)
        ...
        with col1:
            if st.button("🎲 揭示結果（เปิดเผยผลลัพธ์）", key="reveal_nvidia", use_container_width=True):
        ...
        with col1:
            if st.button("🎲 揭示結果（เปิดเผยผลลัพธ์）", key="reveal_hurricane", use_container_width=True):
                st.session_state.nvidia_revealed = True
                st.rerun()
        ...
        with col1:
            if st.button("🎲 揭示結果（เปิดเผยผลลัพธ์）", key="reveal_election", use_container_width=True):
        ...
        if st.session_state.get('election_revealed', False):
            ...
            with col2:
                if st.button("✅ Apply Effect", type="primary", key="apply_election", use_container_width=True):
                    ...
                    st.success(f"🎯 All ETF holdings dropped by 5%!")
                    st.balloons()
      ...
      with col1:
          if st.button("🎲 揭示結果（เปิดเผยผลลัพธ์）", key="reveal_leg", use_container_width=True):
              st.session_state.leg_revealed = True
              st.rerun()

      if st.session_state.get('leg_revealed', False):
          st.markdown("<div style='background: #fff5f5; color: #742a2a; padding: 1rem; border-radius: 8px; border-left: 4px solid #e53e3e; font-size: 2.5rem; font-weight: 600;'>❌ 結果（ผลลัพธ์）：本月無收入！（每月薪資 = $0）（ไม่มีรายได้ในเดือนนี้! เงินเดือนรายเดือน = $0）</div>", unsafe_allow_html=True)
          with col2:
              if st.button("✅ 套用效果（ใช้ผลกระทบ）", type="primary", key="apply_leg", use_container_width=True):
                  # Mark that next advance_month should skip income
                  update_game_state({'skip_next_income': True})

                  st.success(f"🎯 Next month will have NO income!")
                  st.balloons()
        ...
        **Why it's useful:**
        ...
        if selected_player:
            ...
            with col2:
                ...
                st.write(f"🏦 儲蓄 การออมเงิน: ${player_data.get('savings', 0):,.0f}")
...
def main():
    ...
    if page == 'home':
        ...
        student_game_page()
    elif page == 'student_accounting':  # ← ADD THIS
